...
const HostControlView = () => {
  ...
  const {question, setQuestion, answers, setAnswers} = React.useContext(PollContext);
            ...
            <View>
              ...
              {answers.map((answer: any, i: any ) => (
                <div key={i}>
                  ...
                  <TextInput 
                    value={answer.option}
                    onChange={(value) => setAnswers([...answers.slice(0, i), { option: value, votes: 0} , ...answers.slice(i + 1)])}
